<template>
  <div class="container is-fluid" style="height: 100vh">
    <br>
    <h1 class="is-size-3 has-text-centered">Info Payment</h1>
    <div class="columns">
      ...
      <div class="column is-4">
        ...
        <div class="columns">
          ...
          <div class="column">
            <input type="button" class="button is-success" @click="$router.push({ name: 'user-checkout-finish' })" value="Finish"/>
          </div>
        </div>
      </div>
    </div>
